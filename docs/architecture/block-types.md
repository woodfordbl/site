...
| Container | `list`, `checklist`, `columns`, `column`, `table`, `tableRow` | `Container` + `container` behavior (`column` is a generic-scope container) |
