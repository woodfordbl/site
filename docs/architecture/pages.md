...
| Page menu (right) | [`PageHeaderMenu`](../../src/components/pages/page-header-menu.tsx) (single ⋯ trigger): copy link, duplicate, delete, move, font/text-size settings, activity panel, and conditional dev/sync actions |
