...
| Settings | **Font** (Default / Serif / Mono), **Text size** (Auto / Small / Default / Large), and **Full width** toggle (desktop only) — persisted on [`localPageSchema`](../../src/lib/schemas/local-page.ts) (`font`, `textScale`, `fullWidth`) and shipped [`pageSchema`](../../src/lib/schemas/page.ts); typography via [`pageContentTypographyProps`](../../src/lib/pages/page-content-typography.ts) (emits `data-page-text-scale`, driving the `--page-text-scale` / `--fs-*` tokens in `styles.css`); layout via [`pageContentColumnClassName`](../../src/lib/pages/page-content-layout.ts) |
