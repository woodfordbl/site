...
| Database | `database` (placeholder trigger creates and links a workspace database, rendered as a table grid — see [databases](./databases.md)) |
| Divider | `divider` |
