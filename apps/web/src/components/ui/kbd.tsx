...
/**
 * Keyboard keycap chrome. The default `outline` variant name is historical —
 * keycaps use a filled muted surface with **no** border, outline, or ring.
 */
const kbdVariants = cva(
  "pointer-events-none inline-flex select-none items-center justify-center gap-1 font-normal font-sans text-[11px] leading-none [&_svg:not([class*='size-'])]:size-2.5",
  {
    variants: {
      variant: {
        outline: "h-4 min-w-4 rounded-[3px] bg-muted px-1 text-foreground",
        default: cn(
