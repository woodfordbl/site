...
const tabsListVariants = cva(
  "group/tabs-list relative inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground data-[variant=indicator]:rounded-none data-[variant=line]:rounded-none group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col",
  {
    variants: {
      variant: {
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        tabsListVariants({ size: resolvedSize, variant: resolvedVariant }),
        className
      )}
