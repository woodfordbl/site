...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-lg border text-sm outline-none transition-colors duration-100 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-[[data-slot=radio-group-item][data-checked]]:border-primary [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
