...
export const BLOCK_SPECS: { [K in BlockType]: BlockSpec<K> } = {
  ...
  tab: {
    ...
    createDefault: () => createEmptyBlock("tab"),
    behavior: {
      editStrategy: "container",
      capabilities: CONTAINER_CAPABILITIES,
    },
    Container: () => resolveRegisteredContainer("tab"),
    container: BLOCK_CONTAINER_CONFIG.tab,
  },
  tabs: {
    type: "tabs",
    label: "Tabs",
    slashAliases: ["tabs", "tab"],
    icon: IconLayoutNavbar,
    createDefault: () => createEmptyBlock("tabs"),
    behavior: {
      editStrategy: "container",
      capabilities: { ...CONTAINER_CAPABILITIES, slashMenu: true },
    },
    slashItems: [
      {
        ...
        aliases: ["tabs", "tab"],
        icon: IconLayoutNavbar,
        keywords: ["tabs", "tabbed", "tab"],
      },
    ],
    Container: () => resolveRegisteredContainer("tabs"),
    container: BLOCK_CONTAINER_CONFIG.tabs,
  },
  list: {
    type: "list",
    label: "Bullet list",
