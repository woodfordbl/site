 ...
 * shell, topped with a "Previewing" bar whose close action returns to
 * editing. Properties edit the real row (they're the row's live values, same
 * as the row page); the body is read-only and never materializes.
 */
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col max-md:h-auto md:h-full">
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col max-md:flex-none">
        ...
        >
          <div className="flex shrink-0 items-center gap-2 border-sidebar-border border-b bg-muted/40 px-3 py-1.5 text-muted-foreground text-sm">
