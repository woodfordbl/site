...
export type ChartConfig = Record<
  string,
  { label?: string; color?: DitherColor; seed?: Seed }
>
...
export function useChartController({
  ...
  // Stable across renders so the series-registration effects in <Area>/<Bar>/…
  // (which list these in their dep arrays) don't re-run every render. dither-kit
  // relies on React Compiler to memoize these; this app doesn't run it, so pin
  // them with useCallback instead.
